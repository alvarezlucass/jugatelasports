...
export const OfficialMatchList: React.FC<OfficialMatchListProps> = ({ matches, onMatchClick }) => {
                                    ...
                                    <div className="flex flex-col items-center max-w-4xl mx-auto">
                                        ...
                                        <div className="flex items-center justify-center w-full gap-4 md:gap-8">
                                            ...
                                            <div className="flex-1 flex items-center justify-end gap-2 md:gap-4 overflow-hidden">
                                                ...
                                                <div className="w-6 h-4 md:w-10 md:h-7 rounded-sm border border-white/10 overflow-hidden shrink-0 shadow-sm group-hover:border-blue-500/50 transition-colors">
