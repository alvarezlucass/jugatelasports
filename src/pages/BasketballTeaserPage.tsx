...
import { ArrowLeft, Bell, Target, Zap, Shield, Activity, Star } from 'lucide-react';
import { cn } from '../lib/utils';

export const BasketballTeaserPage: React.FC = () => {
    ...
    const leagues = [
        {
            id: 'nba',
            name: 'NBA',
            subtitle: 'El mejor básquet del mundo',
            color: 'from-orange-700/90 to-red-900/90',
        ...
        },
        {
            id: 'wnba',
            name: 'WNBA',
            subtitle: 'Poder y precisión en la cancha',
            color: 'from-rose-700/90 to-pink-900/90',
        ...
        <div className="min-h-screen bg-[#0A0D12] pb-24 animate-in fade-in duration-700">
            ...
            <div className="sticky top-14 md:top-16 z-30 w-full bg-[#131822]/95 backdrop-blur-md border-b border-white/5 shadow-xl">
                <div className="container mx-auto px-4 h-12 flex items-center gap-4">
                    ...
                    <span className="text-xs font-bold text-orange-500 uppercase tracking-widest flex items-center gap-2">
                        <Target size={14} className="fill-orange-500/20" /> Catálogo de Básquet
                    </span>
                </div>
            </div>
            ...
            <main className="container mx-auto px-4 py-8 space-y-16">
                ...
                <section className="relative overflow-hidden rounded-[3rem] bg-[#0F131A] border border-white/5 p-8 md:p-16 text-center md:text-left shadow-2xl">
                    <div className="absolute top-0 right-0 w-full md:w-2/3 h-full bg-gradient-to-l from-orange-600/20 via-red-900/10 to-transparent pointer-events-none" />
                    <div className="relative z-10 max-w-3xl space-y-8 flex flex-col md:block items-center">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-500/10 text-[10px] font-black text-orange-400 border border-orange-500/20 uppercase tracking-[0.2em] shadow-[0_0_15px_rgba(249,115,22,0.2)] animate-pulse">
                            <Activity size={12} />
                        ...
                        <p className="text-zinc-400 text-lg md:text-xl font-medium leading-relaxed max-w-2xl">
                            Estamos construyendo la infraestructura definitiva para que predigas cada noche en las ligas más competitivas de baloncesto del planeta. 
                        </p>
                        
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <Link to="/notify" className="px-8 py-4 bg-orange-600 text-white font-black rounded-full text-sm uppercase tracking-wider hover:bg-orange-500 transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(234,88,12,0.4)] flex items-center justify-center gap-2">
                                <Bell size={18} />
